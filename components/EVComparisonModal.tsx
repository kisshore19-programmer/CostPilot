                                    ...
                                    <div key={i}
                                        ...
                                        <div className="grid grid-cols-4 gap-4 mb-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm font-bold text-emerald-400">RM{ev.monthly_charging_cost?.toFixed(2)}</p>
                                            </div>
                                            <div>
                                                <p className="text-xs text-slate-500 uppercase mb-1">Savings/mo</p>
                                                <p className="text-sm font-bold text-emerald-400">+RM{ev.monthly_savings_vs_petrol?.toFixed(2)}</p>
                                            </div>
                                        </div>
                                            ...
                                            <div className="mt-4 pt-4 border-t border-white/5 space-y-3 animate-fade-in">
                                                <div className="grid grid-cols-3 gap-4">
                                                    <div className="bg-[#0d0820] rounded-xl p-4 text-center">
                                                        ...
                                                        <p className="text-base font-black text-emerald-400">RM{ev.yearly_savings_vs_petrol?.toFixed(2)}</p>
                                                    </div>
                                                    <div className="bg-[#0d0820] rounded-xl p-4 text-center">
